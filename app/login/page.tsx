        ...
        <div className="w-full max-w-md">
          ...
          <form className="mt-8 space-y-5">
            ...
            <div>
              ...
              <input id="password" name="password" type="password" autoComplete="current-password" placeholder="Tu contrasena" className="mt-2 w-full border border-zinc-300 bg-white px-4 py-3 text-zinc-950 outline-none transition-colors placeholder:text-zinc-400 focus:border-lime-600" />
            </div>
            <button type="button" className="w-full bg-lime-400 px-5 py-3.5 text-sm font-bold text-zinc-950 hover:bg-lime-300">
              Ingresar
            </button>
          </form>
