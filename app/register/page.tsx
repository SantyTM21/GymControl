        ...
        <div className="w-full max-w-md">
          ...
          <form action={register} className="mt-8 space-y-5">
            <div>
              ...
              <input id="name" name="name" type="text" autoComplete="name" placeholder="Tu nombre" required minLength={2} className="mt-2 w-full border border-zinc-300 bg-white px-4 py-3 text-zinc-950 outline-none transition-colors placeholder:text-zinc-400 focus:border-lime-600" />
            </div>
            <div>
