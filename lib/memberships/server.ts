...
export type MembershipIndicator = 'active' | 'paused' | 'expiring' | 'expired' | 'cancelled'

export const membershipStatuses: MembershipStatus[] = ['ACTIVE', 'PAUSED', 'EXPIRED', 'CANCELLED']
