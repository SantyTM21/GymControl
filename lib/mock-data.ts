...
export const mockRoutines: Routine[] = [
  {
    ...
    nombre: 'Fuerza total',
    descripcion:
      'Una sesión de cuerpo completo centrada en los movimientos basicos para construir una base solida.',
    nivel: 'INTERMEDIO',
    objetivo: 'FUERZA',
    duracionMinutos: 55,
  ...
  },
  {
    ...
    descripcion:
      'Una sesión controlada para recuperar rangos de movimiento y aliviar la carga del entrenamiento.',
    nivel: 'PRINCIPIANTE',
    objetivo: 'ACONDICIONAMIENTO',
    duracionMinutos: 25,
    createdBy: 'user-owner-01',
...
export const homeBenefits: HomeBenefit[] = [
  {
    ...
    description: 'Organiza cada sesión por objetivo y sigue un plan que puedas cumplir.'
  },
  {
    number: '02',
